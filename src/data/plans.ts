...
export const PLANS: Plan[] = [
  ...
  },
  {
    ...
    benefits: [
      ...
      { text: 'Lifestyle scenarios', built: true },
  ...
  },
  {
    ...
    benefits: [
      ...
      { text: 'Advanced Lifestyle scenarios', built: true },
  ...
  },
  {
    ...
    benefits: [
      ...
      { text: 'Every Lifestyle scenario, tuned by hand', built: true },
...
export const COMPARISON: CompareRow[] = [
  ...
  { label: 'Lifestyle', free: 'Basic', plus: 'Full', pro: 'Advanced', max: 'Deep', built: true },
